...
public class ExternalCheckoutTest {
    ...
    public void createAfterPayLink() throws Exception {
        ...
        ExternalCheckoutRequestAfterPay.Meta meta = new ExternalCheckoutRequestAfterPay.Meta();
            ...
            meta.currency = "AUD";
            ExternalCheckoutRequestAfterPay.Items items1 = new ExternalCheckoutRequestAfterPay.Items(); //set up first item in array
                items1.name = "widget1";
                items1.sku = "1234122346";
                items1.quantity = 1;
                items1.price.amount = new BigDecimal(20);
                items1.price.currency = "AUD";
            ExternalCheckoutRequestAfterPay.Items items2 = new ExternalCheckoutRequestAfterPay.Items(); //set up first item in array
                items2.name = "widget2";
                items2.sku = "1234122345";
                items2.quantity = 1;
                items2.price.amount = new BigDecimal(10);
                items2.price.currency = "AUD";
            meta.items = new ExternalCheckoutRequestAfterPay.Items[] {items1,items2}; //add the items to the meta items array
    ...
    public void createZipMoneyLink() throws Exception {
        ...
        ExternalCheckoutRequestZipMoney.Meta meta = new ExternalCheckoutRequestZipMoney.Meta();
            ...
            charge.items = new ExternalCheckoutRequestZipMoney.Items[] {items1,items2}; //add the items to the meta items array
        meta.charge = charge;
