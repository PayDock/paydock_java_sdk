...
public class ChargeItemResponse  extends Response 
{
    ...
    public static class Payment_Source   
    {
        ...
        public String get_card_number_last4() { return card_number_last4;}
    ...
    public static class Req   
    {
        ...
        private String retain_account;
        public String get_retain_account() {
            return retain_account;
        }
        public void set_retain_account(String value) {
            retain_account = value;
        }
