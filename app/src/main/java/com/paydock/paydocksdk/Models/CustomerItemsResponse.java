...
public class CustomerItemsResponse  extends Response 
{
    ...
    public static class Data   
    {
        ...
        public String get__source_ip_address() {
            return _source_ip_address;
        }
        public void set__source_ip_address(String value) {
            _source_ip_address = value;
        }
        ...
        private Payment_Source[] payment_sources = new Payment_Source[]{};
        public Payment_Source[] get_payment_sources() {
            return payment_sources;
        }
        public void set_payment_sources(Payment_Source[] value) {
